...
| Series | Topic | Entry |
|--------|-------|-------|
| Skills | A catalog of my own Claude Code skills (slash commands) — what each does and when to fire it — so I don't have to remember them. First sub-series: Kaggle competition workflow | [skills/index.html](./skills/index.html) |
...
| Cheap VLM, made strong | How far a small 7B VLM can be pushed with RL and verifiers — the verifier toolkit (episodes 1-15, including BNF-constrained decoding), measured GRPO results on OmniDocBench-JASyn (episode 16), and what an inference-time selector recovers without labels (episode 17) | [vlm-verifier-index.html](./vlm-verifier-index.html) |
